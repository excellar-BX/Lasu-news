...
<div className="w-full  bg-white rounded-3xl overflow-hidden shadow-2xl flex">
        ...
        <div className="hidden md:block w-[45%] relative overflow-hidden rounded-3xl m-3">
          ...
          <div className="absolute top-6 left-6 z-10">
            <div className="flex items-center gap-1">
              <span className="text-white font-black text-2xl tracking-tighter">LASU</span>
          ...
          <div className="absolute bottom-8 left-6 right-6 z-10">
            <h2 className="text-white font-black text-3xl leading-tight mb-2">
              Join the <span className="text-[#e63946]">Conversation.</span>
            </h2>
            <p className="text-white/60 text-sm leading-relaxed">
              Be part of the LASU community. Read, share, and stay informed.
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center px-10 py-10">
          <Link
            to="/"
            className="flex items-center gap-1 text-[#9ca3af] hover:text-[#0a0a0a] text-sm mb-8 transition-colors w-fit"
          >
